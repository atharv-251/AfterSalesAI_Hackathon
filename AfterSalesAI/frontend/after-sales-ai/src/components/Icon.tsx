export type IconName = 'dashboard' | 'orders' | 'deliveries' | 'claims' | 'inventory' | 'knowledge' | 'assistant' | 'arrow' | 'close' | 'menu' | 'search' | 'refresh' | 'send' | 'chevron' | 'alert'
const paths: Record<IconName, string> = {
  ...
  menu: 'M3 6h18 M3 12h18 M3 18h18', search: 'M21 21l-6-6 M17 10a7 7 0 1 1-14 0 7 7 0 0 1 14 0',
