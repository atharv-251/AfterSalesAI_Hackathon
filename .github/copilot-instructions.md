...
- For Tenant 2 UI styling, prefer a light, lower-contrast color palette rather than dark high-contrast themes.
...
## AfterSalesAI Chat Responses
- For AfterSalesAI chat responses, generate short answers containing only relevant information through LLMaaS rather than raw fallback payloads.
